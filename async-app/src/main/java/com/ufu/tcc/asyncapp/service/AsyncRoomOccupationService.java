...
@Service
public class AsyncRoomOccupationService implements RoomOccupationService {
    ...
    @Autowired
    public AsyncRoomOccupationService(RoomOccupationMapper roomOccupationMapper, RoomOccupationRepository roomOccupationRepository, HotelRoomService hotelRoomService) {
